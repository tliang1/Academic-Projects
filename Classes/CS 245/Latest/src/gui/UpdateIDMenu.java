 ...
 *
 */
public class UpdateIDMenu
{
	private JLabel employeeIDLabel = new JLabel("Employee ID:");
	private JTextField employeeIDTextField = new JTextField(12);
	...
	/**
	 * Creates a new UpdateIDMenu given the DatabaseManager object.
	 *
	 * @param dm	database manager
	 */
	public UpdateIDMenu(DatabaseManager dm)
	{
		this.dm = dm;
	}

	/**
	* Displays the update ID menu.
	*/
	public void display()
	{
