...
public class DeleteMenu
{
	...
	/**
	 * Creates a new DeleteMenu given the DatabaseManager object.
	 *
	 * @param dm	database manager
	 */
	public DeleteMenu(DatabaseManager dm)
	{
		this.dm = dm;
	}
		...
		submitButton.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent actionEvent)
			{
				try
				{
					...
					if (id > 0)
					{
						if (dm.deleteEmployee(id))
						{
							JOptionPane.showMessageDialog(null,
									"Record deleted from Employee database successfully.", "Success",
