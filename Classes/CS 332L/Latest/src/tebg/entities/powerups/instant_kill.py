...
class InstantKill(PowerUp):
    """This class represents a instant kill power-up.
    ...
    def __init__(self, images_storage, audio_storage, duration, layer):
        """Sets up the instant kill power-up on creation.
        ...
        Args:
            ...
            layer (int): The layer the instant kill power-up is to be drawn in.
        ...
        img = (images_storage
               .get_image("../../Sprites/Power Ups/instant_kill.png"))
