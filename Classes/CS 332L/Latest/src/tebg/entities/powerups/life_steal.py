...
class LifeSteal(PowerUp):
    """This class represents a life steal power-up.
    ...
    def __init__(self, images_storage, audio_storage, duration, layer):
        """Sets up the life steal power-up on creation.
        ...
        Args:
            ...
            layer (int): The layer the life steal power-up is to be drawn in.
        ...
        img = images_storage.get_image("../../Sprites/Power Ups/life_steal.png")
